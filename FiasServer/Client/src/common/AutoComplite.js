...
export class AutoComplite {
    constructor() {
        this.url = '/api/address/ru/cities/?query=';
        this.db = [];
        this.updPopup = async () => {
        ...
        this.autocompleteResult = document.getElementById('autocomplete_result');
        this.resultDiv = document.getElementById('autocomplete_container');
...
;
//# sourceMappingURL=AutoComplite.js.map